...
var db_url = process.env.WALKLOG_URL || util.format("postgres://%s:%s@%s:%s/%s",
						   process.env.WALKLOG_ENV_POSTGRES_USER,
						   process.env.WALKLOG_ENV_POSTGRES_PASSWORD,
						   process.env.WALKLOG_PORT_5432_TCP_ADDR,
						   process.env.WALKLOG_PORT_5432_TCP_PORT,
						   process.env.WALKLOG_ENV_POSTGRES_USER);
