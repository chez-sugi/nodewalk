...
var db_url = process.env.WALKDB_URL || util.format("postgres://%s:%s@%s:%s/%s",
						   process.env.WALKDB_ENV_POSTGRES_USER,
						   process.env.WALKDB_ENV_POSTGRES_PASSWORD,
						   process.env.WALKDB_PORT_5432_TCP_ADDR,
						   process.env.WALKDB_PORT_5432_TCP_PORT,
						   process.env.WALKDB_ENV_POSTGRES_USER);
